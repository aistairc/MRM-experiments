...
transe.ent_embeddings.weight.data = entity_embeddings
transe.rel_embeddings.weight.data = relation_embeddings
...
transe.save_checkpoint(f'{args.output}/model.ckpt')

# test the model
transe.load_checkpoint(f'{args.output}/model.ckpt')
