...
from openke.module.model import TransE, TransR, TransU
...
# trainer = Trainer(model = model, data_loader = train_dataloader, train_times = 3, alpha = 1.0, use_gpu = True) # for test run
...
if not args.output.exists():
  print('[MAKE OUTPUT DIR]: {args.output}')
